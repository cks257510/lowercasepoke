  ...
  },
  {
    ...
    moves: [
      ...
      },
      {
        ...
        category: "변화",
        pp: 20,
        description: "마음을 가라앉혀 특수공격과 특수방어를 올린다. (Quietly focuses the mind to raise Sp. Atk and Sp. Def.)",
        logicRef: "calm_mind"
      }
    ]
  },
  ...
  },
  {
    ...
    moves: [
      ...
      },
      {
        ...
        category: "변화",
        pp: 20,
        description: "속셈을 굴려 특수공격을 크게 올린다. (The user stimulates its brain to sharply raise Sp. Atk.)",
        logicRef: "nasty_plot"
      }
    ]
  },
...
,
  ...
  },
  {
    ...
    moves: [
      ...
      { nameKo: "껍질에숨기", nameEn: "Withdraw", power: null, accuracy: null, type: "물", category: "변화", pp: 40, description: "껍질 속에 숨어 방어를 올린다. (The user withdraws its body into its hard shell, raising its Defense stat.)" }
    ]
  },
  {
    id: 151,
    ...
    moves: [
      ...
      { nameKo: "베어가르기", nameEn: "Razor Shell", power: 75, accuracy: 95, type: "물", category: "물리", pp: 10, description: "날카로운 껍질로 베어 공격한다. (The user cuts its target with sharp shells. This may also lower the target's Defense stat.)" },
      { nameKo: "칼춤", nameEn: "Swords Dance", power: null, accuracy: null, type: "노말", category: "변화", pp: 20, description: "격렬한 춤으로 공격을 크게 올린다. (A frenetic dance to uplift the fighting spirit. This sharply raises the user's Attack stat.)" }
    ]
  },
  {
    id: 152,
    ...
    moves: [
      ...
      { nameKo: "성장", nameEn: "Growth", power: null, accuracy: null, type: "노말", category: "변화", pp: 20, description: "몸을 크게 만들어 공격 능력을 올린다. (The user's body grows all at once, raising the Attack and Sp. Atk stats.)", logicExplanation: "설명: 공격과 특수공격을 각각 1랭크 올린다." }
    ]
  },
  {
    id: 153,
